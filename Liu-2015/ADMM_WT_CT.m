function [xout, total_time]=ADMM_WT_CT(S,b,param)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   xout = ADMM_WT_CT(S,b,param)
...
% initiate auxiliary variables - r, u1, u2, v, W1, W2
x             = b;
r             = x;
...
% initiate lagrange multipliers - w, y1, y2, z
w = zeros(size(r));
y1 = zeros(size(u1));
y2 = zeros(size(u2));
z = zeros(size(v));
